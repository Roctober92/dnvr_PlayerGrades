...
<p id='desc'>From this, you can kind of get an idea how each player fared. It's also interesting to see how the distribution shapes differ between players. It kind of gives you a window into how expectations are for them.<br><br> For example, how some players tended to receive a "default" grade. <i>(Donskoi was given a **D** grade much more frequent than his other grades.)</i><br><br>I think this graphic - combined with the next graphic - tell more about the nature of player grades than anything else.</p>
